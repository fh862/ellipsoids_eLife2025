...
def get_comment_after_session():
    ...
    comment_text = tk.Text(
        popup, font=entry_font, wrap="word", height=10, width=50
...
class CommunicateViaTextFile:
    ...
    def extract_last_line(self):
        ...
        while True:
            try:
                ...
                with open(self.network_disk_fullfile) as file:
                    last_line = ""
    ...
    def change_background(self, background_RGB, cubicRoom_RGB):
        ...
        message_setup = (
            f"Background_R{background_RGB[0]:.8f}_G{background_RGB[1]:.8f}_B{background_RGB[2]:.8f} "
    ...
    def extract_ref_comp_rgb_values(input_string):
        ...
        try:
            ...
            ref_match = re.search(rf"Ref_{re_pattern}", input_string)
            comp_match = re.search(rf"Comp_{re_pattern}", input_string)
            comp2_match = re.search(rf"Comp2_{re_pattern}", input_string)
