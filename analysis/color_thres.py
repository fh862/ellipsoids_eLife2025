...
class ManualFitFilenames:
    file_name_part1: str = field(
        default="Fitted_isothreshold_isoluminant_plane_360trialsPerRef_9refs_AEPsychSampling_bandwidth0.005_sub",
        init=False,
    )
...
class color_thresholds:
    ...
    def load_CIE_data(self, CIE_version="", num_grid_pts=5):
        ...
        print(
            f"Loaded CIELab simulated data for {self.color_dimension}D case. \n"
