...
W_comp_contour_unscaled = np.full(
    base_size
    + (
        stim_dim,
        numDirPts,
...
for idx in np.ndindex(*base_size):
    ...
    for k in range(numDirPts):
        ...
        (
            ...
            _,
            opt_vecLen[*idx, k],
            rgb_comp_contour_unscaled[*idx, :, k],
    ...
    (
        fitEllipse_scaled[idx],
        fitEllipse_unscaled[idx],
        ellParams[idx],
        W_comp_contour_scaled[idx],
...
fig1, ax1 = sim_CIE_vis.plot_2D_single_plane(
    ref_points_W,
    fitEllipse_scaled,
...
results_keys = [
    ...
    "ellParams",
    "fitEllipse_scaled_RGB",
    "fitEllipse_unscaled_RGB",
    "W_comp_contour_scaled",
