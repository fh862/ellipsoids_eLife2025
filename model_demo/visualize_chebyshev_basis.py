...
visualize_basis.plot_basis_function_2D(degree, grid, settings=pltSettings_2D)
...
phi = (
    chebyshev.evaluate(basis_coeffs, XYZ_mesh[:, 0])[:, :, None, None]
