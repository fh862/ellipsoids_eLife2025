...
output_figDir_fits = os.path.join(
    base_dir, "Experiment_FigFiles", "pilot2", f"sub{subN}", "add_MOCS_data"
)  #'by_sessions')
...
wishart_pred_vis_set2 = WishartPredictionsVisualization(
    expt_trial,
...
fig1.savefig(
    os.path.join(output_figDir_fits, f"{fig_name_part1}.pdf"),
    format="pdf",
    bbox_inches="tight",
)
plt.show()
