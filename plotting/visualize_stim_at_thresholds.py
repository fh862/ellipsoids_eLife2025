...
from plotting.sim_CIELab_plotting import CIELabVisualization, PlotStimAtThresSettings
...
if flag_add_stim_supra:
    ...
    x1_supra = np.array([[0.3, 0.3], [0, 0], [0.6, 0.6], [0.6, 0]])
    xref_supra = x1_supra
...
MOCS_trials_W = {"MOCS_xref_shuffled": MOCS_xref_cat, "MOCS_x1_shuffled": MOCS_x1_cat}
