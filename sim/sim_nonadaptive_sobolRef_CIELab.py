...
from analysis.trial_placement import (
    StimConfig_isoluminant_sobolref,
    StimConfig_RGBslices_sobolref,
    ...
    stim_config = StimConfig_isoluminant_sobolref(
        **common_kwargs,
        ...
        sobol_lb=[
            ...
            -0.7,
            0,
        ],  # data will be in model space (bounded between -1 and 1) for the isoluminant plane
    ...
    stim_config = StimConfig_RGBslices_sobolref(
        **common_kwargs,
        ...
        sobol_lb=[
            ...
            0.15,
            0,
        ],  # data will be in normalized RGB space (bounded between 0 and 1) for other planes
...
figname = (
    f"SimTrialData_nonadaptive_{psyfield_dims}DExpt_{str_optional}{colordiff_alg}_"
...
sampling_vis.plot_sampling(xref[:, vd], x1[:, vd], ax=ax, settings=pltSettings_tp)
