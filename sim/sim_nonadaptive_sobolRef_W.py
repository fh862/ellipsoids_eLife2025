...
from analysis.trial_placement import StimConfig_W_sobolref, TrialPlacement_sobolRef_W
...
stim_config = StimConfig_W_sobolref(
...
figname = (
    f"SimTrialData_nonadaptive_{ndims * 2}DExpt_{str_optional}{str2_optional}"
